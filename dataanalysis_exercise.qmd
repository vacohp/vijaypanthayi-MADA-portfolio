...
This step created three different data set variables: clean_toptendeath --\> original data set without the "113 Cause Name" column ga_clean_toptendeath --\> clean_toptendeath but only with the observations regarding Georgia ga_suicide --\> ga_clean_toptendeath but only with the observations regarding suicide
