...
**This is the original figure:** ![](Visual_Exercise_Graph_Original.png)
...
- The order of the values for age group bars
- Label the bars ON the graph (hence the legend)
- Split up All Adult Men from the individual age groups, but still have all of the bars on the same graph
